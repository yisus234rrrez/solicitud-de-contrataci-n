        ...
        <div class="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl p-8 md:p-12 border border-white/20">
            <div class="text-center mb-10">
                ...
                <?php if (isset($_COOKIE['pref_nombre'])): ?>
                    <p class="text-brand-main mt-2 font-bold animate-bounce">¡Bienvenido de nuevo,
            ...
            <form action="php/login.php" method="POST" class="space-y-6">
                <?php if (isset($_GET['error'])): ?>
                    <div
                        class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl text-sm font-medium animate-shake">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required
                        value="<?php echo $_COOKIE['pref_email'] ?? ''; ?>" placeholder="ejemplo@correo.com"
                ...
                <!-- BOTÓN -->
                <button type="submit"
                    class="block w-full text-center bg-brand-main hover:bg-brand-hover text-white font-semibold py-4 rounded-xl shadow-lg shadow-brand-soft transition-all duration-200 transform hover:-translate-y-1 active:scale-95">
                    Ingresar
                </button>
            </form>
