...
<body class="bg-gray-50 min-h-screen text-gray-800 pb-20">
    ...
    <main class="max-w-7xl mx-auto px-6 py-10">
        ...
        <form action="php/guardar_solicitud.php" method="POST" enctype="multipart/form-data" id="solicitudForm"
            ...
            <div class="p-8 space-y-8">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                        <span
                            class="w-8 h-8 bg-brand-soft text-brand-main rounded-full flex items-center justify-center mr-3 text-sm font-bold">1</span>
                        Información General
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <input type="date" name="fecha_solicitud" id="fecha_solicitud"
                                class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 outline-none">
                        </div>
                        <div>
                            ...
                            <input type="text" name="dependencia" id="dependencia"
                                value="<?php echo $_COOKIE['pref_dep'] ?? ''; ?>" placeholder="Ej. Finanzas"
                        ...
                        <div>
                            ...
                            <select name="tipo_solicitud" id="tipo_solicitud"
                                class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 outline-none focus:border-brand-main transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" name="cargo" id="cargo" placeholder="Ej. Analista"
                                class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 outline-none">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                        <span
                            class="w-8 h-8 bg-brand-soft text-brand-main rounded-full flex items-center justify-center mr-3 text-sm font-bold">2</span>
                        Detalle de Servicios y Presupuesto
                    </h2>

                    <div class="border border-gray-200 rounded-2xl shadow-sm bg-white overflow-hidden table-container">
                        <table class="w-full border-collapse text-sm">
                            <thead>
                                <tr class="bg-white border-b border-gray-100 text-[13px] text-center tracking-tight">
                                    <th rowspan="2" class="px-6 py-5 text-left font-bold text-slate-700 align-middle">
                                        Servicio</th>
                                    <th rowspan="2" class="px-6 py-5 text-center font-bold text-slate-700 align-middle">
                                        Cantidad</th>
                                    <th colspan="2"
                                        class="px-6 py-3 text-center font-bold text-slate-700 border-b border-gray-100">
                                        Centro de costos</th>
                                    <th colspan="2"
                                        class="px-6 py-3 text-center font-bold text-slate-700 border-b border-gray-100">
                                        Rubro</th>
                                    <th rowspan="2" class="px-6 py-5 text-center font-bold text-slate-700 align-middle">
                                        Disponibilidad<br>presupuestal</th>
                                    <th rowspan="2" class="px-6 py-5 text-center font-bold text-slate-700 align-middle">
                                        Fondo</th>
                                    <th colspan="2"
                                        class="px-6 py-3 text-center font-bold text-slate-700 border-b border-gray-100">
                    ...
                    <div class="mt-6 flex justify-start">
                        <button type="button" id="btnAgregarFila"
                            ...
                            <span
                                class="w-6 h-6 rounded-full border-2 border-emerald-500 flex items-center justify-center mr-2 group-hover:bg-emerald-50 transition-colors">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                        <span
                            class="w-8 h-8 bg-brand-soft text-brand-main rounded-full flex items-center justify-center mr-3 text-sm font-bold">3</span>
                        Justificación de la Solicitud
                    </h2>
                    <div>
                        <textarea name="justificacion" id="justificacion" rows="3"
                            placeholder="Describe brevemente por qué se requiere este servicio..."
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                        <span
                            class="w-8 h-8 bg-brand-soft text-brand-main rounded-full flex items-center justify-center mr-3 text-sm font-bold">4</span>
                        Documentación de Soporte
                    </h2>
                    <div onclick="document.getElementById('adjunto').click()"
                        class="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center cursor-pointer hover:border-brand-main transition-colors">
                        <p class="text-gray-600">Haz clic aquí para subir tu soporte</p>
                        <p class="text-xs text-gray-400">Solo PDF hasta 5MB</p>
            ...
            <div class="bg-gray-50 px-8 py-6 border-t flex justify-end space-x-4">
                ...
                <button type="submit" class="px-8 py-3 bg-brand-main text-white font-bold rounded-xl shadow-lg">Guardar
                    Solicitud</button>
            </div>
        </form>
    </main>

    <script src="js/solicitud-manager.js?v=<?php echo time(); ?>"></script>
