...
<body class="bg-gray-50 min-h-screen text-gray-800">
    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="php/logout.php" class="text-sm font-medium text-red-600 hover:text-red-800 mr-4">Cerrar
                        Sesión</a>
                    <div
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-10">
            ...
            <p class="mt-2 text-lg text-gray-500">Bienvenido de nuevo, <?php echo $_SESSION['usuario']; ?>. Gestiona tus
                procesos de forma rápida y eficiente.</p>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <a href="solicitud.php"
                class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-brand-soft hover:border-brand-light transition-all duration-300 transform hover:-translate-y-2 w-full max-w-sm">
                <div
            ...
            <a href="solicitudes.php"
                class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-blue-100 hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-2 w-full max-w-sm">
                <div
            ...
            <?php if ($_SESSION['usuario'] === 'Administrador'): ?>
                <a href="revision.php"
                    class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-amber-100 hover:border-amber-200 transition-all duration-300 transform hover:-translate-y-2 w-full max-w-sm">
                    <div
