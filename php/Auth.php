...
class Auth
{
     ...
     * Revisa si ya hay una sesión activa para evitar el error "Session already started".
     */
     ...
     * Retorna verdadero si inicia sesión, o falso si falla.
     */
    public static function login($email, $password)
    {
        self::init();

        // Credenciales estáticas a modo de simulación o mock.
        // Simulamos un super usuario administrador
